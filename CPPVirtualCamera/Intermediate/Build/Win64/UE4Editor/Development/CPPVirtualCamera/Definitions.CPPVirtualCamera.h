...
#define UE_PROJECT_NAME CPPVirtualCamera
#define UE_TARGET_NAME CPPVirtualCameraEditor
#define UE_MODULE_NAME "CPPVirtualCamera"
...
#define CPPVIRTUALCAMERA_API DLLEXPORT
